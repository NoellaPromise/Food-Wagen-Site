          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <details className="group relative">
                <summary className="list-none cursor-pointer w-8 h-8 rounded-full bg-white/90 hover:bg-white flex items-center justify-center shadow-md border border-gray-100">
                  <span className="sr-only">Open menu</span>
                  <span className="text-gray-700 font-bold">⋮</span>
                </summary>
                <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-100 py-1 w-28 z-30">
                  <button
